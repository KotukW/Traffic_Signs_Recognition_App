...
model = load_model("D:\Python\Traffic_Signs_Recognition_App\\traffic_classifier_2.h5")
def preprocessingImage(img):
    image_fromarray = Image.fromarray(img, 'RGB')
    resize_image = image_fromarray.resize((30, 30))
    print(np.array(resize_image).shape)
...
def getClassName(classNo):
    ...
    elif classNo == 31: return "Wild anumals crossing"
...
while True:
    ...
    img = preprocessingImage(img)/255
